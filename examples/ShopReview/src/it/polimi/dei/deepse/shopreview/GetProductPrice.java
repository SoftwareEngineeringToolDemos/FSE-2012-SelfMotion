 ...
 */
public class GetProductPrice extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(getIntent().getExtras().containsKey("productName")){
		...
		runOnUiThread(new Runnable() {
			...
			@Override
			public void run() {
				AlertDialog.Builder alert = new AlertDialog.Builder(GetProductPrice.this);

				alert.setTitle("Price");
				alert.setMessage("Please, enter the price for "+productName);

				// Set an EditText view to get user input
				input = new EditText(GetProductPrice.this);
				alert.setView(input);
