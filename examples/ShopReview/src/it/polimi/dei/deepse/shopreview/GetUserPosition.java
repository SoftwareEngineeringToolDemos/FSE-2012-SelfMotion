...
public class GetUserPosition extends Activity {
	...
	protected void onPostCreate(Bundle savedInstanceState) {
		...
		dialog = ProgressDialog.show(GetUserPosition.this, "", "Trying to get your position. Please wait...", true);
		...
		locationListener = new LocationListener() {
			public void onLocationChanged(Location location) {
				if (timerTask.cancel()) {
					...
					dialog.dismiss();
					Toast.makeText(GetUserPosition.this,
							"User location retrieved!", 2).show();
